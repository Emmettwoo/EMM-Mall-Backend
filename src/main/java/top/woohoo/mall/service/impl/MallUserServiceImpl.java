...
public class MallUserServiceImpl extends ServiceImpl<MallUserMapper, MallUser> implements MallUserService {
    ...
    public List<MallUser> listUser(MallUserListDTO dto) {
        ...
        LambdaQueryWrapper<MallUser> wrapper = new LambdaQueryWrapper<MallUser>()
                .like(dto.getUserId() != null, MallUser::getId, dto.getUserId())
                .like(dto.getUsername() != null, MallUser::getUsername, dto.getUsername())
                .like(dto.getEmail() != null, MallUser::getEmail, dto.getEmail())
                .like(dto.getPhone() != null, MallUser::getPhone, dto.getPhone());
